...
// import { NaiveUiTable } from 'meng-ui'
import type { FormSchema, Recordable } from 'meng-ui'

const message = useMessage()

// 勾选回调
function handleCheck(param: string[]) {
...
function fun(type: string, row: Recordable) {
  message.info(type, row)
}

// 模拟接口请求
function api(params: Recordable) {
